...
import com.example.twitteranalyzer.*
...
class TwitterListFragmentTest :
    ...
    fun setUp() {
        stopKoin()
        startKoin {
            modules(listOf(fakeTwitterRepository,
                    viewModelModule))
        }
    }
    ...
    fun navigationToTwitterAnalyze() {
        ...
        val scenario = launchFragmentInContainer<TwitterListFragment>(null, R.style.Theme_TwitterAnalyzer)
        ...
        Mockito.verify(navController).navigate(
                TwitterListFragmentDirections.actionShowAnalyzerFrament(TwitterModel(1,"mock","luan")))
    }
